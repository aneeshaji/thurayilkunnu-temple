    ...
    const slides = [
        {
            ...
            title: isML ? 'ഭഗവാൻ മുരുകന്റെ' : 'Sacred Sanctuary of',
            highlight: isML ? 'ദിവ്യ സന്നിധി' : 'Lord Murugan',
            desc: isML 
                ? 'പതിറ്റാണ്ടുകളുടെ ആത്മീയ പൈതൃകവും ശാന്തിയും അനുഭവിച്ചറിയൂ. പരമ്പരാഗത താന്ത്രിക വിധിപ്രകാരമുള്ള നിത്യ പൂജകൾ.' 
                : 'Immerse in decades of divine spiritual grace, traditional Kerala tantric rituals, and serene sanctuary peace.'
        },
        {
            url: '/images/banners/banner2.jpg',
            tag: isML ? 'ശ്രീകോവിൽ ദർശനം' : 'Sanctum Sanctorum Blessings',
            title: isML ? 'ശ്രീ ബാലമുരുകന്റെ' : 'Seat of Divine Child',
            highlight: isML ? 'അഭയ വരദാനം' : 'Balamurugan',
            desc: isML 
                ? 'ഭക്തർക്ക് അഭയവും അനുഗ്രഹവും വർഷിക്കുന്ന ശ്രീ ബാലമുരുക സന്നിധിയിലെ ശാന്തവും ഭക്തിസാന്ദ്രവുമായ അനുഭവം.' 
                : 'Experience the pure bliss and divine protection of Balamurugan in our traditional sanctum courtyard.'
        },
        {
            url: '/images/banners/banner3.jpg',
            tag: isML ? 'പുരാതന ആത്മീയ കേന്ദ്രം' : 'Ancient Seat of Spiritual Wisdom',
            title: isML ? 'സനാതനമായ' : 'Experience Timeless',
            highlight: isML ? 'ദിവ്യചൈതന്യം' : 'Spiritual Grace',
            desc: isML 
                ? 'നിത്യ പൂജകളിലും വിശേഷാൽ വഴിപാടുകളിലും തൈപ്പൂയം ഉൾപ്പെടെയുള്ള മഹോത്സവങ്ങളിലും പങ്കുകൊള്ളൂ.' 
                : 'Join thousands of devoted souls in daily poojas, sacred vazhipadu offerings, and grand Thaipusam celebrations.'
        },
        {
            url: '/images/banners/banner4.jpg',
            tag: isML ? 'പുണ്യ വഴിപാടുകൾ' : 'Vazhipadu & Special Offerings',
            title: isML ? 'സർവ്വ ഐശ്വര്യങ്ങൾക്കും' : 'Seek Blessings &',
        ...
        },
        {
            ...
            tag: isML ? 'ഉപദേവതാ സന്നിധികൾ' : 'Auspicious Upadevatha Shrines',
            title: isML ? 'ഗണപതിയും അമ്മ ഭഗവതിയും' : 'Blessings of Lord',
            highlight: isML ? 'നാഗദേവതകളും' : 'Mahaganapathy',
            desc: isML 
                ? 'ശ്രീ മഹാഗണപതി, ദുർഗ്ഗാ ഭഗവതി, മഹാദേവൻ, നാഗരാജാവ് തുടങ്ങിയ ഉപദേവതകളുടെ അനുഗ്രഹം തേടൂ.' 
                : 'Seek holy blessings at the ancient shrines of Lord Ganapathy, Bhagavathy, and Nagadevathas.'
        }
    ];
