          ...
          >
            ...
            >
              ...
              <div className="drawer-quick-chips">
                <Link to="/about#timetable" className="drawer-chip-link" onClick={() => setIsOpen(false)}>
                  <span>⏱ {isML ? 'പൂജാ സമയം' : 'Timings'}</span>
                </Link>
                <Link to="/about#dresscode" className="drawer-chip-link" onClick={() => setIsOpen(false)}>
                  <span>🪔 {isML ? 'ആചാരങ്ങൾ' : 'Dress Code'}</span>
                </Link>
                <Link to="/offerings#nakshatra-finder" className="drawer-chip-link" onClick={() => setIsOpen(false)}>
              ...
              <div className="drawer-footer">
                ...
                <a href="tel:+917994342205" className="drawer-phone-link">
                  <Phone size={15} />
