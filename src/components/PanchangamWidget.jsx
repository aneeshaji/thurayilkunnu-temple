                ...
                >
                        ...
                        <div className="pw-today-control">
                            {isToday ? (
                                ...
                                <button
                                    ...
                                    title={isMl ? "ഇന്നത്തെ ദിവസത്തിലേക്ക്" : "Reset to today"}
                                >
                                    <RotateCcw size={13} />
                                    <span>{t('panchangam.today')}</span>
                                </button>
                    ...
                    <div className="pw-date-navigator">
                        <button
                            ...
                            aria-label={isMl ? "മുമ്പത്തെ ദിവസം" : "Previous day"}
                            title={isMl ? "മുമ്പത്തെ ദിവസം" : "Previous day"}
                        >
                            <ChevronLeft size={20} />
                        </button>
                        ...
                        <button
                            ...
                            onClick={() => setDate(d => addDays(d, 1))}
                            aria-label={isMl ? "അടുത്ത ദിവസം" : "Next day"}
                            title={isMl ? "അടുത്ത ദിവസം" : "Next day"}
                        >
